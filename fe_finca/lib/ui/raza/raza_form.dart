...
class RazaForm extends StatefulWidget {
  @override
  _RazaFormState createState() => _RazaFormState();
}

class _RazaFormState extends State<RazaForm> {
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    _buildDatoCadena(capturaNombreAct, "Nombre Raza:"),
                          ...
                          ElevatedButton(
                            onPressed: () async {
                              if (_formKey.currentState!.validate()) {
                                ...
                                print("NA:${_nombreRaza}");

                                /*var api = await Provider.of<RazaApi>(
                                    context,
                                    listen: false)
                                    .crearRaza(TokenUtil.TOKEN,mp);
                                ...
                                BlocProvider.of<RazaBloc>(context).add(CreateRazaEvent(mp));
                                Navigator.pop(context, () {
                                  //setState(() {});
                                });
                              } else {
